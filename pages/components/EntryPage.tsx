    ...
    <div className="mt-20">
      <div className="flex flex-col lg:flex-row">
        <div className="flex flex-col justify-center order-1 w-full lg:w-3/5">
          <h1 className="text-5xl tracking-wider mb-2 mx-auto md:-ml-0">
            I&apos;m <span className="font-bold">{HEADER}</span>
          </h1>
        ...
        <div className="flex flex-row lg:justify-end order-2 w-full mt-8 lg:mt-0 lg:w-2/5 mb-8">
          <img
            className="lg:w-10/12 w-8/12 lg:mr-0 rounded-xl shadow-xl mx-auto md:-ml-0"
