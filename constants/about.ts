...
export const CODING_AT_HOME_TEXT_PART_THREE = `. I am mostly interested in the newest technologies and techniques, for example I recently have delved
...
export const BELLE_HEADER = 'BELLE';
export const BELLE_TEXT = `My dachshund called Belle is my wife and my joy. We enjoy taking her on long walks near the beach or we
...
export const HOBBIES_TEXT = `Other things i like to do apart from Coding at home is play Video Games. I have played Video Games just
