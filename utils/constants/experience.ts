export const JOB_ONE_TITLE =
  "Frontend Developer - YoungOnes (October 2021 - Present)";
export const JOB_ONE_TEXT = `
...
export const JOB_TWO_TITLE =
  "Full Stack Developer - Blink (October 2019 - October 2021)";
export const JOB_TWO_TEXT = `Duuk, an online platform developed and maintained by Blink, contains educational and innovative modules for
